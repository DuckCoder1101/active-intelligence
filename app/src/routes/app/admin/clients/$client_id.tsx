...
const TABS = [
  { id: 'informacoes', label: 'Informações', icon: MdOutlineInfo },
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex shrink-0 gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-border px-4 py-2 text-[13px] font-semibold text-text-sub transition-colors hover:bg-bg hover:text-text"
                  >
                    <MdEdit size={15} />
                    Editar
                  </button>
